...
//     try {
//       const response = await axios.post('http://localhost:8001/posts', { title, body });
...
//         <select id="community" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
//           <option>r/developersIndia</option>
